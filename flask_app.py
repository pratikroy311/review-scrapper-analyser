...
def index():
    if request.method == 'POST':
        ...
        try:
            dbConn = pymongo.MongoClient("mongodb://127.0.0.1:27017")  # opening a connection to Mongo
            db = dbConn['reviewScrapAnalyser'] # connecting to the database called crawlerDB
            ...
            if reviews.count() > 0: # if there is a collection with searched keyword and it has records in it
                ...
                for commentbox in commentboxes:
                    ...
                    mydict = {"Product": searchString, "Name": name, "Rating": rating, "CommentHead": commentHead,
                              "Comment": custComment,"sentiment":main.predict(custComment)} # saving that detail to a dictionary
